# 1. 6900원 나누기 80g 곱하기 100은 8625원이 아니고 8620원?

결론 : 1. 1.0을 쓴다, 2. CAST를 쓴다. 3. (안해봤지만)처음부터 가격도 REAL로 한다 근데 이건 INTEGER인 전제로 하는게 좋겠지

Generated Column(생성된 컬럼)으로 100G당 가격을 하려면 새로 만든다음에 기존 테이블에서 옮겨야 된다. 귀찮지만...
